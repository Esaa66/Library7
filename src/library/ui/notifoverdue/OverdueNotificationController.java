package library.ui.notifoverdue;
...
import library.ui.notifoverdue.emailsender.EmailSenderController;
...
public class OverdueNotificationController implements Initializable {
    ...
    private void handleSendNotificationAction(ActionEvent event) {
        ...
        Object controller = LibraryAssistantUtil.loadWindow(getClass().getResource("/library/ui/notifoverdue/emailsender/email_sender.fxml"), "Notify Overdue", null);
        if (controller != null) {
    ...
    public static class NotificationControlCellValueFactory implements Callback<CellDataFeatures<NotificationItem, JFXCheckBox>, ObservableValue<JFXCheckBox>> {
        ...
        @Override
        public ObservableValue<JFXCheckBox> call(CellDataFeatures<NotificationItem, JFXCheckBox> param) {
